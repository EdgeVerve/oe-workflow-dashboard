...
/**
 * ### oe-completed-workflow
 * Display workflow instances with completed main process details.
 * 
 * @customElement
 * @polymer
 * 
 ...
 */
class oeCompletedWorkflow extends OEAjaxMixin(OECommonMixin(PolymerElement)) {
  static get template() {
    return html`
    ...
    <paper-dialog id="wfdialog">
    <div class="search center horizontal justified layout">
    ...
    wfDefns.forEach(function (wf) {
      ...
      wf.workflowInstances.forEach(function (inst) {
        ...
        inst.processes.forEach(function (proc) {
          ...
          if(proc.processDefinitionName === wfdef.name && status === 'complete'){
...
window.customElements.define(oeCompletedWorkflow.is, oeCompletedWorkflow);